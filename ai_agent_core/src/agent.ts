...
===================================================================`;
        ...
        systemPrompt = isThaiQuestion
          ? `คุณคือ AI Assistant ผู้เชี่ยวชาญที่จะสร้างคำตอบใหม่อย่างละเอียดและครบถ้วน โดยอ้างอิงจากฐานความรู้ที่ยืนยันแล้ว
...
${context}
================================================`
          : `You are an expert AI Assistant that creates comprehensive and detailed new answers based on verified knowledge base data.
