...
app.use(async (req: express.Request, res: express.Response, next: express.NextFunction) => {
  ...
  const publicPaths = ["/auth/login", "/auth/register", "/auth/styleRL.css", "/api/message", "/api/create_record", "/auth/login.js", "/auth/register.js","/auth/admin", "/api/download-script", "/api/detect-platform", "/.well-known/appspecific/com.chrome.devtools.json", "/api/set-model", "/api/save_img", "/api/stop", "/api/get-all-verified-answers", "/api/search-verified-answers", "/api/submit-verified-answer", "/api/submit-verification", "/api/get-verifications", "/api/related-questions", "/api/related-questions-all", "/api/chat/-1/files", "/api/create_guest_user"];
